...
The eligibility is ____
		...
		Scanner input=new Scanner(System.in);
		  System.out.println("Do you need a lone?");
		  ...
		  if (loan) {
		   ...
		   System.out.print("The eligibility is ");
		    if (score<600) {
		      ...
		      System.out.print("Maybe eligible");
		    }else if(score>=701 && score<=800) {
		      System.out.print("Eligible");
		    }else {
		      System.out.print("Definitely eligible");
		    }
		  }else {
		   System.out.print("The eligibility is Unknown");
		   } 
	}
}